...
import theme from './presentationTheme.js';

// DEFAULT LAYOUT

export const DefaultSlide = ({ children, ...rest }) => (
  <Slide bgColor="primary" align="center top" maxWidth="1400px" {...rest}>
...
export const TitleSlide = ({ children, ...rest }) => (
    <Slide bgColor="primary" align="center center" maxWidth="1200px" {...rest}>
        <MDXProvider components={components}>{children}</MDXProvider>
    </Slide>
);
